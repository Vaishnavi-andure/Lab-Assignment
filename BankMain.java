...
public class BankMain {
	public static void main(String[] args) {
		BankAccount savingsAccount = new SavingsAccount(3000, 460);
	    BankAccount checkingAccount = new CheckingAccount(1000, 110);

	    withdrawFromAccount(savingsAccount, 420);
	    withdrawFromAccount(checkingAccount, 320);
